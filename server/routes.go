...
var routes = Routes{
	...
	Route{"ChartsExpensesByCategory", http.MethodGet, "/api/charts-expenses-by-category", true, api.ChartsExpensesByCategory},
	Route{"ChartsExpensesByWeek", http.MethodGet, "/api/charts-expenses-by-week", true, api.ChartsExpensesByWeek},
	Route{"ChartsExpensesByMonth", http.MethodGet, "/api/charts-expenses-by-month", true, api.ChartsExpensesByMonth},
	Route{"ChartsPieExpensesByCategory", http.MethodGet, "/api/charts-pie-expenses-by-category", true, api.ChartsPieExpensesByCategory},
	...
	Route{"Categories", http.MethodGet, "/api/categories", true, api.Categories},
	...
	Route{"UserAuth", http.MethodPost, "/api/auth", true, api.UserAuth},
	Route{"UserUpdate", http.MethodPut, "/api/user/{id}", true, api.UserUpdate},
	Route{"UserDelete", http.MethodDelete, "/api/user/{id}", true, api.UserDelete},
}
